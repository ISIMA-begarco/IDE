...
\pause
  ...
  \item
    ...
    \begin{itemize}
\pause
      \uncover<5->{\item créateur d'interface graphique}
\pause
      \uncover<6->{\item recherche avancée}
\pause
      \uncover<7->{\item versioning}
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}[allowframebreaks]
  ...
  \bibitem{cle}
    Eclipse
    \newblock {\em C, C++, Java, Perl, Ruby, etc}.
    \newblock http://www.eclipse.org/, 2013.
  ...
  \bibitem{Someone2000}
    NetBeans
    \newblock {\em C/C++, PHP, XML, HTML, PHP, Groovy, Javadoc, JavaScript et JSP}.
    \newblock http://fr.netbeans.org/, 2013.
  \end{thebibliography}
\end{frame}
